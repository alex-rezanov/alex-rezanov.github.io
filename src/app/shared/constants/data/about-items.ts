...
export const INTERESTING_ITEMS: interestingItem[] = [
  {
    ...
    highlighted:
      'I’ve been doing sports since I was a child and spent quite a huge part of my life in professional athletics. ',
    description:
      'I’m multiple national champion and former member of Ukrainian national team. Physical activity is for life with me.',
    images: ['assets/images/welcome.jpg'],
  },
  {
    title: 'Chess is in my heart',
    highlighted:
      'I am totally obsessed with chess for more than 5 years now, absolutely best game and great metaphor of life. ',
    description:
      'For those who understand: my best ELO is 1968 in blitz on Chess.com (striving for 2000).',
    images: ['assets/images/welcome.jpg'],
  },
  {
    ...
    description:
      'Btw I’ve listened to almost all recognised counties anthems and rated them in my notes.',
